        ...
        <div className="col s12 m10 l10 offset-l1 offset-m1">
          ...
          {props.role === "passenger" &&
            (props.rides.length ? (
              ...
              <div className="driver-label no-rides ">
                Aucun trajet correspond à vos critères
              </div>
            ))}
        </div>
